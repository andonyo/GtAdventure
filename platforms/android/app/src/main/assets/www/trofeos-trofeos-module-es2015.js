...
let TrofeosPageModule = class TrofeosPageModule {
};
...
let TrofeosPage = class TrofeosPage {
    constructor(db) {
        this.db = db;
    ...
    GetTrof() {
        this.db.GetTrofeos(this.correo).then((data) => {
            console.log(data);
            this.datos = data;
        }, (error) => {
            console.log(error);
...
//# sourceMappingURL=trofeos-trofeos-module-es2015.js.map