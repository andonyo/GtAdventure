...
let TristePageModule = class TristePageModule {
};
...
let TristePage = class TristePage {
    constructor(router) {
        this.router = router;
    }
    scanear() {
...
//# sourceMappingURL=triste-triste-module-es2015.js.map