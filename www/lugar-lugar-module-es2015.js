...
let LugarPageModule = class LugarPageModule {
};
...
let LugarPage = class LugarPage {
    ...
    Getcoment() {
        this.db.GetComent(this.imagenes).then((data) => {
            console.log(data);
            this.datos = data;
        }, (error) => {
            console.log(error);
...
//# sourceMappingURL=lugar-lugar-module-es2015.js.map