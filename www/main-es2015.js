...
/* harmony import */ var firebaseui_angular__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! firebaseui-angular */ "./node_modules/firebaseui-angular/fesm2015/firebaseui-angular.js");
...
/* harmony import */ var _app_services_database_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../app/services/database.service */ "./src/app/services/database.service.ts");
    ...
    signInOptions: [
        {
            ...
            provider: firebaseui_angular__WEBPACK_IMPORTED_MODULE_9__["firebase"].auth.EmailAuthProvider.PROVIDER_ID
        },
    ],
    tosUrl: '/inicio'
};
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"],
            ...
            firebaseui_angular__WEBPACK_IMPORTED_MODULE_9__["FirebaseUIModule"].forRoot(firebaseUiAuthConfig)],
        providers: [
            ...
            _app_services_database_service__WEBPACK_IMPORTED_MODULE_16__["DatabaseService"],
...
let DatabaseService = class DatabaseService {
    ...
    createTable() {
        ...
        this.sqlite.create({ name: "data.db", location: "default" }).then((db) => {
            this.databaseObj = db;
    ...
    CreateUser(nombre, correo, imagen, puntos) {
    ...
    CreatePremio(usuario, descripcion, imagen, puntos, tiempo, fecha) {
        return new Promise((resolve, reject) => {
    ...
    CreateComent(usuario, descripcion, imagen, lugar) {
        return new Promise((resolve, reject) => {
...
const environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyCxiZQZ7EpvNfV3aPZdK2FAW_Hp1M5uxVY",
        authDomain: "gtadventure-40da8.firebaseapp.com",
        databaseURL: "https://gtadventure-40da8.firebaseio.com",
        projectId: "gtadventure-40da8",
        storageBucket: "gtadventure-40da8.appspot.com",
        messagingSenderId: "914468608099",
        appId: "1:914468608099:web:61d8389791078c8fb10056",
        measurementId: "G-C002DK5QBZ"
    }
};
/*
...
module.exports = __webpack_require__(/*! /home/andony/Documentos/ionic/gtAdventure2/src/main.ts */"./src/main.ts");
